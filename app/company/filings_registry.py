...
REGISTRY: Dict[str, FilingPage] = {
    ...
    'beppyo_5_1': {'title': '別表５(1)', 'template': 'company/filings/beppyo_5_1.html'},
    'beppyo_5_1_copy': {'title': '利益積立金額の計算（別表５(1)）コピー', 'template': 'company/filings/beppyo_5_1_copy.html'},    'appropriation_calc_beppyo_5_2': {'title': '納税充当金の計算（別表５(2))', 'template': 'company/filings/appropriation_calc_beppyo_5_2.html'},
