...
SOA_FORM_FIELD_METADATA: dict[str, list[dict[str, object]]] = {
    'deposits': [
        ...
        {'name': 'balance', 'placeholder': '例：1000000', 'type': 'number'},
        {'name': 'remarks', 'placeholder': '摘要を入力（任意）'},
    ],
    'notes_receivable': [
    ...
    'notes_payable': [
        {'name': 'registration_number', 'placeholder': '例：1234567890123'},
        {'name': 'payee', 'placeholder': '例：株式会社△△'},
        {'name': 'issue_date'},
        {'name': 'due_date'},
        {'name': 'payer_bank', 'placeholder': '例：〇〇銀行'},
        {'name': 'payer_branch', 'placeholder': '例：本店'},
        {'name': 'amount', 'placeholder': '例：300000'},
        {'name': 'remarks', 'placeholder': '摘要（任意）'},
    ],
    'accounts_payable': [
        {'name': 'registration_number', 'autofocus': True, 'placeholder': '例：1234567890123'},
    ...
    'misc_income': [
        {'name': 'account_name'},
        {'name': 'details', 'placeholder': '例：内容'},
        {'name': 'amount', 'placeholder': '例：金額'},
        {'name': 'remarks', 'placeholder': '摘要（任意）'},
    ],
    'misc_losses': [
        {'name': 'account_name'},
